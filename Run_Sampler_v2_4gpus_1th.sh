...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/SamlperV2_2th/Qwen3-1.7B"
export FS_QUEUE_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2_2th/Rollout/Qwen3-1.7B"
export SYNC_WEIGHTS_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2/tmp_2th/Qwen3-1.7B/gpg_async_weights.pt"
