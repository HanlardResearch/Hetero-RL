...
wandb_name=$2
model_name=$3
log_path=/userhome/Research_HUB/GPG/Hetero-RL/log_dir/rebuttal/online/${loss_type}/${wandb_name}_${formatted_time}.log
mkdir -p "$(dirname "$log_path")"
export WANDB_MODE=offline
export WANDB_DIR=/userhome/Research_HUB/GPG/Hetero-RL/wandb/rebuttal/online/${loss_type}
...
# data model config
#export dataset_name="/userhome/Research_HUB/GPG/Hetero-RL/Data_Dir/deepmath_103k_dataset"
export dataset_name="/extrahome0/HF_datasets/Hetero-RL/simplelr_qwen_level3to5"
...
accelerate launch --config_file recipes/accelerate_configs/zero2_4A100s.yaml \
  ...
  src/hetero_rl/online_rl.py --config $config --output_dir $SAVEPATH \
