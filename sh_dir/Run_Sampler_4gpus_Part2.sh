...
scriptname=$1
xth=$2
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/sampler/$1_part2_$2thExp_${formatted_time}.log
echo $log_path
...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/SamlperV2_vllm_{$2}th/Qwen3-1.7B"
export FS_QUEUE_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2_vllm_{$2}th/Rollout/Qwen3-1.7B"
export SYNC_WEIGHTS_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2_vllm/tmp_{$2}th/Qwen3-1.7B/gpg_async_weights.pt"
...
accelerate launch --config_file recipes/accelerate_configs/ddp_4gpus.yaml \
  ...
  src/open_r1/$scriptname.py --config  recipes/Qwen2.5-Math-7B/grpo/config_simple_rl_math_l35_v1_vllm.yaml --output_dir $SAVEPATH \
