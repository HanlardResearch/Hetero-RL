...
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/gpg/${formatted_time}.log

export WANDB_MODE=offline
export WANDB_DIR=/userhome/Research_HUB/GPG/open-r1/wandb/gpg
...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/GPG/Qwen3-1.7B"
...
accelerate launch --config_file recipes/accelerate_configs/zero2_4A100s.yaml \
  ...
  src/open_r1/gpg.py --config  recipes/Qwen2.5-Math-7B/grpo/config_simple_rl_math_l35_v1_vllm.yaml --output_dir $SAVEPATH \
  ...
  --per_device_train_batch_size 16  --per_device_train_batch_size 8 --eval_strategy "steps" --eval_steps 32 --eval_on_start True --seed 2025 \
  --logging_steps 1 > $log_path 2>&1