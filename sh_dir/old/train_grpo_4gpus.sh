...
loss_type=$1
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/${loss_type}/${formatted_time}.log
...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/GEPO_Online/Qwen3-1.7B"
...
accelerate launch --config_file recipes/accelerate_configs/zero2_4A100s.yaml \
  ...
  --per_device_eval_batch_size 16  --per_device_train_batch_size 8 --eval_strategy "steps" --eval_steps 64 --eval_on_start True \
  --logging_steps 1  --use_vllm True --loss_type $loss_type --use_benchmark > $log_path 2>&1 &
