...
scriptname=$1
xth=$2
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/sampler/$1_part3_$2_cfg$3_${formatted_time}.log
echo $log_path
...
export SAVEPATH=/userhome/save_dir/GPG/4gpus/Sampler_${xth}/part3/Qwen3-1.7B
...
accelerate launch --config_file recipes/accelerate_configs/ddp_4gpus.yaml \
  ...
  --num_train_epochs 5 --gradient_accumulation_steps 1 --max_completion_length 3072 --max_prompt_length 768 \
  ...
  --per_device_train_batch_size 4 --log_completions True \
