...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/Samlper/Qwen3-1.7B"
export FS_QUEUE_PATH="/extrahome0/save_dir/GPG/4gpus/debug/Async/Rollout/Qwen3-1.7B"
export SYNC_WEIGHTS_PATH="/extrahome0/save_dir/GPG/4gpus/Async/tmp/debug/Qwen3-1.7B/gpg_async_weights.pt"
...
accelerate launch --config_file recipes/accelerate_configs/ddp_4gpus.yaml \
  ...
  --model_name_or_path "/extrahome0/HF_models/Qwen/Qwen3-0.6B" --dataset_name "/extrahome0/HF_datasets/open-r1/simplelr_qwen_level3to5" \
