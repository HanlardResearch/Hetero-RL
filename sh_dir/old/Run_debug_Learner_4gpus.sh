...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/debug/Learner/Qwen3-1.7B"
...
accelerate launch --config_file recipes/accelerate_configs/zero2_4A100s.yaml \
  ...
  src/open_r1/learner_script_debug.py --config   recipes/Qwen2.5-Math-7B/grpo/config_simple_rl_math_l35_v1.yaml --output_dir $SAVEPATH \
  ...
  --max_steps 1295 --per_device_train_batch_size 8  --gradient_accumulation_steps 1 \
