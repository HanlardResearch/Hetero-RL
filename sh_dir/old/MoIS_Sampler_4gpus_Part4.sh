...
cfg=$3
########################## parameters ##########################
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/AsyncGRPO/sampler/$1_part4_$2_cfg$3_${formatted_time}.log
echo $log_path
...
export SAVEPATH=/userhome/save_dir/AsyncGRPO/4gpus/Sampler_${xth}_cfg${cfg}/part4/Qwen3-1.7B
