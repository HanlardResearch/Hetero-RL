...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/LearnerV3_vllm_${xth}th/Qwen3-1.7B"
export FS_QUEUE_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV3_vllm_${xth}th/Rollout/Qwen3-1.7B"
export SYNC_WEIGHTS_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV3_vllm/tmp_${xth}th/Qwen3-1.7B/gpg_async_weights.pt"
