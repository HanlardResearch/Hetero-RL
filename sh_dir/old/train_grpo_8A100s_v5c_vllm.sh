...
accelerate launch --config_file recipes/accelerate_configs/zero2_8A100s.yaml \
  ...
  --save_total_limit  5 --num_train_epochs 5 --gradient_accumulation_steps 16 --max_completion_length 4096 --max_prompt_length 768 \
  ...
  --per_device_eval_batch_size 4  --per_device_train_batch_size 2 --eval_strategy "steps" --eval_steps 32 --eval_on_start True --seed 2025 \
