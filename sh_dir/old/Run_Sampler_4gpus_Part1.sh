...
scriptname=$1
xth=$2
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/sampler/$1_part1_$2_cfg$3_${formatted_time}.log
echo $log_path
...
export SAVEPATH=/userhome/save_dir/GPG/4gpus/Sampler_${xth}/part1/Qwen3-1.7B
