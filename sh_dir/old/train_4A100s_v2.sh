...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/Qwen3-0.6B"
...
accelerate launch --config_file recipes/accelerate_configs/zero2_4A100s.yaml \
  ...
  --save_strategy "epoch" --save_total_limit  5 --num_train_epochs 5 --gradient_accumulation_steps 8 --max_completion_length 2048 --max_prompt_length 768 \
