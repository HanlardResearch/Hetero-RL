...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus"
accelerate launch --config_file recipes/accelerate_configs/zero2_4A100s.yaml \
  ...
  --model_name_or_path "/extrahome0/HF_models/Qwen2.5-Math-1.5B" --dataset_name "/extrahome0/HF_datasets/open-r1/simplelr_qwen_level3to5" \
