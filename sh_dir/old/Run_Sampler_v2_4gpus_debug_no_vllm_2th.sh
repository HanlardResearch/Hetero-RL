...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/SamlperV2_debug_wovllm_2th/Qwen3-1.7B"
export FS_QUEUE_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2_debug_wovllm_2th/Rollout/Qwen3-1.7B"
export SYNC_WEIGHTS_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2/tmp_debug_wovllm_2th/Qwen3-1.7B/gpg_async_weights.pt"
...
accelerate launch --config_file recipes/accelerate_configs/ddp_4gpus.yaml \
  ...
  src/open_r1/sampler_script_v2_wovllm.py --config   recipes/Qwen2.5-Math-7B/grpo/config_simple_rl_math_l35_v1.yaml --output_dir $SAVEPATH \
