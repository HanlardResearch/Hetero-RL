...
accelerate launch --config_file recipes/accelerate_configs/zero2_4A100s.yaml \
  ...
  src/open_r1/grpo.py --config  recipes/Qwen2.5-Math-7B/grpo/config_simple_rl_math_l35_v2_vllm.yaml --output_dir $SAVEPATH \
  ...
  --per_device_eval_batch_size 16  --per_device_train_batch_size 8 --eval_strategy "steps" --eval_steps 32 --eval_on_start False --seed 2025 \
  --logging_steps 1  --use_vllm True