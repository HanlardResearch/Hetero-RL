...
export SAVEPATH="/extrahome0/save_dir/GPG/8gpus/${loss_type}/${formatted_time}/Qwen3-1.7B"
...
accelerate launch --config_file recipes/accelerate_configs/zero2_8A100s.yaml \
  ...
  --save_total_limit  1 --num_train_epochs 10 --gradient_accumulation_steps 8 --max_completion_length 2048 --max_prompt_length 768 \
