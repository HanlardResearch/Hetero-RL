...
cfg=$3
########################## parameters ##########################
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/AsyncGRPO/sampler/$1_part2_$2_cfg$3_${formatted_time}.log
echo $log_path
...
export SAVEPATH=/userhome/save_dir/AsyncGRPO/4gpus/Sampler_${xth}_cfg${cfg}/part2/Qwen3-1.7B
...
accelerate launch --config_file recipes/accelerate_configs/ddp_4gpus.yaml \
  ...
  --seed 42 \
  --vllm_gpu_memory_utilization 0.9 > $log_path 2>&1
