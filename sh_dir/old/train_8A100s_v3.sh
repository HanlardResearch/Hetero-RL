...
export WANDB_DIR=/userhome/Research_HUB/GPG/open-r1/8gpus
...
export SAVEPATH="/extrahome0/save_dir/GPG/8gpus/Qwen3-1.7B"
accelerate launch --config_file recipes/accelerate_configs/zero2_8A100s.yaml \
  ...
  --save_total_limit  5 --num_train_epochs 5 --gradient_accumulation_steps 2 --max_completion_length 2048 --max_prompt_length 768 \
