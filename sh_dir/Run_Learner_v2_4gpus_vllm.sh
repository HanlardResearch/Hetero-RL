...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/LearnerV2_vllm/Qwen3-1.7B"
export FS_QUEUE_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2_vllm/Rollout/Qwen3-1.7B"
export SYNC_WEIGHTS_PATH="/extrahome0/save_dir/GPG/4gpus/AsyncV2_vllm/tmp_1/Qwen3-1.7B/gpg_async_weights.pt"
