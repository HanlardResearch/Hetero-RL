...
scriptname=$1
xth=$2
log_path=/userhome/Research_HUB/GPG/open-r1/log_dir/learner/$1_$2thExp_${formatted_time}.log
...
export SAVEPATH="/extrahome0/save_dir/GPG/4gpus/LearnerV2_vllm_{$2}th/Qwen3-1.7B"
