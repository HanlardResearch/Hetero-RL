...
# Remove stale hetero_rl.egg-info directory to avoid https://github.com/pypa/pip/issues/5466
stale_egg_info = Path(__file__).parent / "hetero_rl.egg-info"
if stale_egg_info.exists():
    print(
        (
            "Warning: {} exists.\n\n"
            "If you recently updated hetero_rl, this is expected,\n"
            "but it may prevent hetero_rl from installing in editable mode.\n\n"
...
setup(
    ...
    license="Apache",
    url="https://github.com/huggingface/hetero_rl",
    package_dir={"": "src"},
