...
class SamplerGRPOTrainer(GRPOTrainer):
    ...
    def run_sampling_loop(self):
        ...
        while True:
            ...
            push_to_fs_queue(self, self.queue_dir, cpu_rollout_data, time_save, self.rank)
...
def main(script_args, training_args, model_args):
    ...
    partition_dataset = shuffled_dataset.shard(num_shards=4, index=script_args.sampler_id)
    ...
    trainer = SamplerGRPOTrainer(
        ...
        args=training_args,
        train_dataset=partition_dataset,
        eval_dataset=None,
