...
class Learner_MoISTrainer(Trainer):
    ...
    def _compute_loss(self, model, inputs):
        ...
        learner_seq_p = learner_seq_lopp.detach().exp()
        ...
        self._metrics[mode]["avg_learner_seq_p"].append(learner_seq_p.mean().item())
        self._metrics[mode]["std_learner_seq_p"].append(learner_seq_p.std().item())
